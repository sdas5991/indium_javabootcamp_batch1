...
public class BankingAppWithThreadedImportExport {
    private static Map<Integer, BankAccount> accounts = new HashMap<>();
    private static int accountIdCounter = 1;
    private static final ExecutorService executor = Executors.newFixedThreadPool(2); // Two threads for import and export
